...
//Note: we use for..in loop to deal with objects
//Note: the easiest way to enumerate an object is using for..in loop
...
//Note: to check if an property in an object we use "in" operator
